            ...
            EduTutorVA: [
                {
                    ...
                    for K-12 students. As part of a group assignment for my senior design project class, 
                    our goal was to find an organization and provide an IT solution for them. 
                    The requirements we received for this project were to provide a centralized and 
                    structured method of accessing and storing resources for tutors and staff, 
                    create a functional contact form that encourages schools and tutors to partner with 
                    EduTutorVA, and redesign the website to be more attractive. 
            ...
            VuexGame: [
                {
                    ...
                    description: `This application is a turn-based game where the user takes turns with the computer, using various moves.
            ...
            MovieApp: [
                {
                    ...
                    description: `This is a movie application that allows users to both search for and view information about 
            ...
            ReduxStore: [
                {
                    ...
                    description: `This application simulates a website where the user can buy items using a fixed amount of money. 
                    Items are first added to the cart before they are purchased. 
                    The cart can be accessed at any time, allowing the user to either remove items or choose to check out. 
                    The user is given a predetermined amount of money and will not be allowed to add any more items if they run out, 
                    meaning they will have to remove items from their cart. This application uses React, JavaScript, and CSS.`,
